...
#ifndef PR_MISSING_NEWMAT10_LIB
  void copyToNewmat( ::NEWMAT::Matrix& dest, bool fTranspose = false ) const;
  void copyToNewmat( ::NEWMAT::SymmetricMatrix& dest ) const;
  void copyFromNewmat( ::NEWMAT::Matrix& src, bool fTranspose = false );
  void copyFromNewmat( ::NEWMAT::DiagonalMatrix& src );
#endif // PR_MISSING_NEWMAT10_LIB
