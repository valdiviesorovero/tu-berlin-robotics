...
#define GV_COPY(gvdest,gvsrc)	gvdest.dof=gvsrc.dof; \
gvdest.curTime=gvsrc.curTime;\
gvdest.A=gvsrc.A;\
gvdest.B=gvsrc.B;\
gvdest.mu=gvsrc.mu;\
gvdest.Lambda=gvsrc.Lambda;\
gvdest.G=gvsrc.G;\
gvdest.p=gvsrc.p;\
gvdest.singularities=gvsrc.singularities;\
gvdest.E=gvsrc.E;\
gvdest.Einverse=gvsrc.Einverse;\
gvdest.tau=gvsrc.tau;\
gvdest.q=gvsrc.q;\
gvdest.dq=gvsrc.dq;\
gvdest.kp=gvsrc.kp;\
gvdest.kv=gvsrc.kv;\
...
gvdest.dx=gvsrc.dx;\
gvdest.qd=gvsrc.dq;\
gvdest.dqd=gvsrc.dqd;\
gvdest.ddqd=gvsrc.ddqd;\
gvdest.xd=gvsrc.xd;\
gvdest.dxd=gvsrc.dxd;\
gvdest.ddxd=gvsrc.ddxd;\
gvdest.elbow=gvsrc.elbow;\
gvdest.T=gvsrc.T;\
gvdest.Td=gvsrc.Td;\
gvdest.J=gvsrc.J;\
gvdest.Jtranspose=gvsrc.Jtranspose;\
gvdest.qmin=gvsrc.qmin;\
gvdest.qmax=gvsrc.qmax;\
gvdest.dqmax=gvsrc.dqmax;\
gvdest.ddqmax=gvsrc.ddqmax;\
gvdest.taumax=gvsrc.taumax;\
gvdest.xmin=gvsrc.xmin;\
gvdest.xmax=gvsrc.xmax;\
gvdest.dxmax=gvsrc.dxmax;\
gvdest.ddxmax=gvsrc.ddxmax;\
gvdest.wmax=gvsrc.wmax
